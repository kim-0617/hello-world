...
def display_start_screen():
    ...
    # 종료 버튼
    pygame.draw.circle(screen, WHITE, end_button.center, 100, 5)
    msg2 = game_font.render("END", True, WHITE)
    msg_rect2 = msg.get_rect(center= (55,120))
...
# 종료 버튼
end_button = pygame.Rect(0, 0, 200, 200)
end_button.center = (120, 120)
